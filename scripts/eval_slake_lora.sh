...
LORA_MODEL_PATH="/project2/ruishanl_1185/SDP_for_VLM/outputs/llava-med-v1.5-SLAKE-finetune/epoch_9"

# Base model (LLaVA-Med v1.5)
BASE_MODEL="microsoft/llava-med-v1.5-mistral-7b"

# VQA-RAD test data paths
TEST_DATA="/project2/ruishanl_1185/SDP_for_VLM/datasets/SLAKE/Slake1.0/llava_test.jsonl"
IMAGE_FOLDER="/project2/ruishanl_1185/SDP_for_VLM/datasets/SLAKE/Slake1.0/imgs"

# Output path for predictions
OUTPUT_DIR="/project2/ruishanl_1185/SDP_for_VLM/outputs/llava-med-v1.5-SLAKE-finetune/lora/eval"
mkdir -p $OUTPUT_DIR
ANSWERS_FILE="$OUTPUT_DIR/slake_llava_test_predictions_9.jsonl"
