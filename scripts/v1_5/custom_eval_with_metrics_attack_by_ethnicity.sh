#!/bin/bash
#SBATCH --job-name=llava_rex_eval_attack_by_ethnicity
...
# Data Configuration
QUESTION_FILE="/project2/ruishanl_1185/SDP_for_VLM/datasets/rexgradient/ReXGradient/metadata/rexgradient_train_ethnicity_likelihood.json"
IMAGE_FOLDER="/project2/ruishanl_1185/SDP_for_VLM/datasets/rexgradient/ReXGradient"
ANSWERS_FILE="/project2/ruishanl_1185/SDP_for_VLM/outputs/xinyang/llava_rex/dp_lora_weight_128/eval/ethnicity_likelihood_with_metrics.jsonl"  # Output file
