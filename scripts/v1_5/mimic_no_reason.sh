...
OUTPUT_DIR="/scratch1/runhuixu/outputs/llava_llavarad/lora_128_gpt4_no_reason"
...
MIMIC_INCLUDE_REASON=False        # Include clinical indication/reason in prompts
...
bash eval_mimic.sh $OUTPUT_DIR False
