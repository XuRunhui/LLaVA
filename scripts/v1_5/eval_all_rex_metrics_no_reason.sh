...
#SBATCH --job-name=eval_metrics_rex_no_reason
...
conda activate /project2/ruishanl_1185/SDP_for_VLM/envs/llavarad
export PYTHONNOUSERSITE=1
export LD_LIBRARY_PATH="$CONDA_PREFIX/lib:$LD_LIBRARY_PATH"
cd /project2/ruishanl_1185/SDP_for_VLM/Xinyang/LLaVA_DP/LLaVA

MODEL_NAME=${1:-"/project2/ruishanl_1185/SDP_for_VLM/outputs/xinyang/llava_rex/lora_weight_128_no_reason"}
BOOTSTRAP_CI=${2:-"true"}
...
# Base paths
EVAL_BASE_DIR="/project2/ruishanl_1185/SDP_for_VLM/outputs/xinyang/llava_rex/lora_weight_128_no_reason/eval/results"
RESULTS_BASE_DIR="/project2/ruishanl_1185/SDP_for_VLM/outputs/xinyang/llava_rex/lora_weight_128_no_reason/eval/"
