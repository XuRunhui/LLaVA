...
TEST_DATA="/project2/ruishanl_1185/SDP_for_VLM/datasets/vqa_rad/test.jsonl"
...
find /project2/ruishanl_1185/SDP_for_VLM/outputs/llava-med-v1.5-vqarad-finetune/lora -maxdepth 1 -type f -exec cp {} $Checkpoint_DIR \;
