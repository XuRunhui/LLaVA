...
DATA_PATH="/project2/ruishanl_1185/SDP_for_VLM/datasets/SLAKE/Slake1.0/train_candidate.json"
IMAGE_FOLDER="/project2/ruishanl_1185/SDP_for_VLM/datasets/SLAKE/Slake1.0/imgs"
OUTPUT_DIR="/project2/ruishanl_1185/SDP_for_VLM/outputs/llava-med-v1.5-SLAKE-finetune/lora"
